...
import 'package:myapplication/client/indexclientmg.dart';


import '../helepers/cachehelpers.dart';
import 'infocard.dart';

class Ajoutcartemg extends StatefulWidget {
  const Ajoutcartemg({Key? key}) : super(key: key);

  @override
  _AjoutcartemgState createState() => _AjoutcartemgState();
}

class _AjoutcartemgState extends State<Ajoutcartemg> {
  bool isFormulaireVisible = true;
  final _formKey = GlobalKey<FormState>();
  // Définir la variable sur false initialement
  String? _code;
  Map<String, dynamic> carteInformations = {};
  Map<String, dynamic> historiqueClient = {};
  void initState() {
    if (CacheHelper.getInfoExist() != null) {
      getData();
    }
    setState(() {});
    super.initState();
    ...
    if (_formKey.currentState!.validate()) {
      ...
      FirebaseFirestore.instance
        ...
        if (querySnapshot.size > 0) {
          ...
          String marqueAttendue = 'Mg'; // Marque attendue pour la vérification
              ...
              child: Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Image.asset('images/mgcarte.jpg', width: 200, height: 200),
                    const SizedBox(height: 20),
                    TextFormField(
                      onChanged: (value) {
                        setState(() {
